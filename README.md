...
<br />
The main view is the note list screen. When the application starts, the user's list of notes will appear and the user can see a shortcut for each note.<br />
In this screen, the user can see the other users' notes by switching the owner options segment picker (myself or other users) at the middle bottom of the screen.<br />
When the user taps on the note item:<br />
- If on the "my self" mode, the update note screen will appear so that the user can edit the note. Or swipe from right to left to show the delete note.<br />
- If on the "other users", the detail note screen will appear so that the user can see all other user note's content.<br />
<br />
<div>
